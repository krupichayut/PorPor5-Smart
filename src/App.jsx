            ...
            {isDataLoaded ? (
              <Suspense fallback={<PageLoading />}>
                <AnimatedRoutes>
                  ...
                  <Route path="/course-plan" element={<CoursePlanContainer activeClassId={activeClassId} classes={classes} indicators={indicators} setIndicators={setIndicators} lessonPlans={lessonPlans} setLessonPlans={setLessonPlans} readOnly={readOnly} appSettings={appSettings} />} />
